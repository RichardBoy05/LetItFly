...
public interface StatsTable {
    ...
    String[] S_COLUMNS = {S_COLUMN_DATE, S_COLUMN_ROUTINE, S_COLUMN_REPS, S_COLUMN_OUTCOME};
    String[] S_COLUMNS_ID_INCLUDED = {S_COLUMN_ID, S_COLUMN_DATE,  S_COLUMN_ROUTINE, S_COLUMN_REPS, S_COLUMN_OUTCOME};
